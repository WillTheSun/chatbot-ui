...
AS $$
DECLARE
  project_url TEXT := 'https://eeebnhjfejcbzeudvbfm.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVlZWJuaGpmZWpjYnpldWR2YmZtIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0MzgxODU4NCwiZXhwIjoyMDU5Mzk0NTg0fQ.m_dbm-_nbKnccN9dCq1dlWqbjP66fgEjCiCTLkhfDec'; -- full access needed for http request to storage
